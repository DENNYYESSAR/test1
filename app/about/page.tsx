    ...
    <div className="min-h-screen">
      ...
      <section className="py-24 relative bg-white/40 backdrop-blur-sm">
        ...
        <div className="absolute inset-0 opacity-5">
          ...
          <div className="absolute bottom-20 left-20 w-40 h-40 bg-indigo-400 rounded-full"></div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-slideInLeft">
              ...
              <div className="grid grid-cols-2 gap-3 md:gap-6 mt-8 md:mt-12">
                <div className="glass-panel p-4 md:p-6 rounded-xl md:rounded-2xl text-center hover:scale-105 transition-transform duration-300 bg-white/50 backdrop-blur-xl border border-white/20">
      ...
      <section className="py-24 bg-white/60 backdrop-blur-sm relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-40 left-20 w-32 h-32 bg-blue-400 rounded-full animate-float"></div>
          <div className="absolute bottom-40 right-20 w-40 h-40 bg-indigo-400 rounded-full animate-float" style={{animationDelay: '2s'}}></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-panel bg-white/50 backdrop-blur-xl p-8 rounded-3xl shadow-xl border border-white/20 card-hover group">
      ...
      <section className="py-24 bg-white/40 backdrop-blur-sm relative overflow-hidden">
        {/* Background decoration */}
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-20 right-40 w-64 h-64 bg-blue-400 rounded-full animate-float"></div>
          <div className="absolute bottom-20 left-40 w-48 h-48 bg-indigo-400 rounded-full animate-float" style={{animationDelay: '1s'}}></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="animate-slideInLeft">
              <div className="glass-panel bg-gradient-to-br from-blue-50 to-purple-50 rounded-3xl p-8 shadow-2xl border border-white/20">
                ...
                <div className="mt-6 grid grid-cols-3 gap-4">
                  <div className="bg-white/50 backdrop-blur-xl rounded-xl p-4 text-center border border-white/20">
            ...
            <div className="animate-slideInRight">
              ...
              <div className="space-y-6">
                <div className="glass-panel bg-white/50 backdrop-blur-xl p-6 rounded-2xl border border-white/20 card-hover group">
                ...
                <div className="glass-morphism bg-white/80 backdrop-blur-lg p-6 rounded-2xl border border-purple-100/50 card-hover group">
                  <div className="flex items-start space-x-4">
                ...
                <div className="glass-morphism bg-white/80 backdrop-blur-lg p-6 rounded-2xl border border-cyan-100/50 card-hover group">
                  <div className="flex items-start space-x-4">
      ...
      <section className="py-24 bg-white/60 backdrop-blur-sm relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          ...
          <div className="absolute bottom-20 right-20 w-32 h-32 bg-indigo-400 rounded-full animate-float" style={{animationDelay: '2s'}}></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-panel bg-white/50 backdrop-blur-xl rounded-3xl overflow-hidden shadow-xl border border-white/20 card-hover group">
